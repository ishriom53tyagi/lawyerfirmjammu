(function(e) {
    e.fn.camera = function(t, n) {
        ...
        } else if (t.container != false) {
            e(t.container).css("background", "none").prepend('<div class="slideshowck_container_wrap"></div>');
            e(".slideshowck_container_wrap", t.container).prepend(o);
            if (e(t.container).css("position") != "relative" && e(t.container).css("position") != "absolute") {
                e(t.container).css("position", "relative").css("z-index", "0")
            }
            o.parent(".slideshowck_container_wrap").css({
                height: "100%",
                "margin-left": 0,
                "margin-right": 0,
                "margin-top": 0,
        ...
        var a;
        if ((navigator.userAgent.match(/MSIE 8.0/i) || navigator.userAgent.match(/MSIE 7.0/i) || navigator.userAgent.match(/MSIE 6.0/i)) && t.loader != "none") {
            a = "bar"
        } else {
            a = t.loader
        }
